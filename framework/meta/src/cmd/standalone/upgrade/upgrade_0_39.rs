...
fn v_0_39_replace_in_files(sc_crate_path: &Path) {
    replace_in_files(
        ...
        "*Cargo.toml",
        &[
            Query::substring("elrond-wasm-debug", "dharitri-sc-scenario"),
            Query::substring("elrond-wasm-modules", "dharitri-sc-modules"),
            Query::substring("elrond-wasm-node", "dharitri-sc-wasm-adapter"),
            Query::substring("elrond-wasm", "dharitri-sc"),
        ][..],
    );
