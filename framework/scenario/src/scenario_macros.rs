...
macro_rules! managed_token_id {
    ($bytes:expr) => {{
        dharitri_sc::types::TokenIdentifier::from_esdt_bytes($bytes)
    }};
}
...
macro_rules! managed_token_id_wrapped {
    ($bytes:expr) => {{
        let ___esdt_token_id___ = dharitri_sc::types::TokenIdentifier::from_esdt_bytes($bytes);
        dharitri_sc::types::EgldOrEsdtTokenIdentifier::esdt(___esdt_token_id___)
    }};
}
...
macro_rules! managed_egld_token_id {
    () => {{
        dharitri_sc::types::EgldOrEsdtTokenIdentifier::egld()
    }};
}
